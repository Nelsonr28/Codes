...
class nodoSig{ // Clase NodoSig para albergar informacion de los siguiendos
public:
...
nodoTweets(string t1,string t2, nodoTweets* _t){ //constructor de la clase nodoTweets
_twitero=t1;
_tweet=t2;
proxTweet=_t;
}
